...
var AdvancedSearchComponent = /** @class */ (function () {
    ...
    AdvancedSearchComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.rForm.valueChanges.pluck('search').filter(function (t) { return !!t; }).subscribe(function (search) {
            var params = __assign({}, _this.route.snapshot.queryParams, { search: search });
            _this.router.navigate([], { relativeTo: _this.route, queryParams: params });
        });
